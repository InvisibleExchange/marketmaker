...
* @returns {string}
*/
module.exports.pedersen_binding = function(a, b) {
    try {
...
* @returns {string}
*/
module.exports.pedersen_on_vec_binding = function(arr) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
const path = require('path').join(__dirname, 'starknet_bg.wasm');
